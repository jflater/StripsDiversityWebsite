...
plot <- p + stat_compare_means(aes(group = soil_type), label = "p.signif") +
  ...
  xlab("Sampling Day") + scale_fill_viridis_d(name = "Managment", labels = c("Ag", "Prairie"))
plot
ggsave("../Figures/WorleD1Chao1.png", plot = plot, device = "png", width = 6, height = 4, units = "in")
```
```{r Shannon}
library(ggpubr)
sample_data <- sample_data(Wd1) %>%
...
plot <- p + stat_compare_means(aes(group = soil_type), label = "p.signif") +
  ...
  xlab("Sampling Day") + scale_fill_viridis_d(name = "Managment", labels = c("Ag", "Prairie"))
plot
ggsave("../Figures/WorleD1Shannon.png", plot = plot, device = "png", width = 6, height = 4, units = "in")
```
```{r}
...
Just prairie soils pairwise comparison
```{r}
